...
def main():
    ...
    base_weight = [0.1 * np.random.randn(16, 40), 0.1 * np.random.randn(40, 4)]

    gaussian = [[np.random.randn(16, 40) * 0.1, np.random.randn(40, 4) * 0.1] for a in range (population_size)]
